			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="page-login.php" class="active"><i class=""></i> <span>PAGE LOGIN</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
				...
				<div class="container-fluid">
				   ...
				   <li>
							...
							<div id="subPages" class="collapse ">
								...
								<ul class="nav" >
									<li><a href="planingAdmin.php?code_fil=<?php echo ($fil['code_fil']) ?>" style="color: black;"><?php echo ($fil['code_fil']) ?></a></li>
