...
<body>
	...
	<div id="wrapper">
		...
		<?php  require_once("connection.php");
            ...
            $mod=$_GET['id_mod'];
            $req="SELECT *FROM filiere join etudiant using (id_fil) JOIN note USING(id_etud) JOIN examen USING(id_exam) JOIN element USING(id_elem) JOIN module USING(id_mod) join module_filiere using(id_mod)  WHERE (code_fil='$code_fil' && id_semestre='$id_smst' && DATE_FORMAT(SYSDATE(), '%Y')=DATE_FORMAT(dateFin, '%Y')) && id_mod='$mod'";
			$rs=$conn ->query($req);
            ?>
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="choixModAdmin.php?id_semestre=s5&code_fil=<?php echo $code_fil ?>" ><span>SEMESTRE 5</span> </a>

                                    
									</li>
									<li><a href="choixModAdmin.php?id_semestre=s6&code_fil=<?php echo $code_fil ?>" ><span>SEMESTRE 6</span></a>
						</li>
					</ul>
				</div>
			</li>
						...
						<li>
							...
							<div id="subPages1" class="collapse ">
								<ul class="nav">
									<li><a href="planingAdmin.php?code_fil=<?php echo $code_fil ?>"  class="">planing des examens</a></li>
