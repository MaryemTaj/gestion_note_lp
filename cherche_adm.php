...
$sql="select etudiant.id_etud as id_e,note.note_exam as note,etudiant.cne as cne, etudiant.cin as cin,
concat(etudiant.nom_etud ,' ' ,etudiant.prenom_etud) as Nom_Prenom ,element.nom_elem as element,
module.id_mod ,module.nom_mod as module,session.* ,
semestre.id_semestre as S,filiere.code_fil as filiere
from note inner JOIN etudiant on etudiant.id_etud=note.id_etud 
inner join examen on examen.id_exam=note.id_exam 
inner join filiere on filiere.id_fil=etudiant.id_fil 
inner join session on examen.id_session=session.id_session 
inner join element on element.id_elem=examen.id_elem 
inner join module on module.id_mod=element.id_mod 
INNER join semestre on semestre.id_semestre=module.id_semestre 
where etudiant.cne like '%$cher%'or
etudiant.id_etud like '$cher'or
 etudiant.nom_etud like '%$cher%'or
 etudiant.prenom_etud like '%$cher%'or
 module.id_mod like '$cher' or
 filiere.code_fil like '%$cher%' or 
 etudiant.cin like '%$cher%' ";
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            ...
            <div class="container-fluid">
                ...
                <form class="navbar-form navbar-left" action="cherche_adm.php" method="post">
