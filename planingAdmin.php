    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>tableau <b>des examens</b></h2>
            ...
            $req="select *from examen join element using(id_elem) join module using(id_mod) join module_filiere using(id_mod) join filiere using(id_fil) where code_fil='$fil' && DATE_FORMAT(date, '%Y')=DATE_FORMAT(SYSDATE(), '%Y')";
            $rs=$conn ->query($req);
            ?>
			...
			while($et=mysqli_fetch_assoc($rs)){ ?>
                <tbody>
                    ...
                    <tr>
                        <td><?php echo ($et['id_exam']); ?></td>
                       
                        <td><?php echo ($et['nom_elem']); ?></td>
                       
                        <td><?php echo ($et['date']); ?></td>
                        <td><?php echo ($et['id_semestre']); ?></td>
