						...
						<li>
							...
							<div id="subPages1" class="collapse ">
								<ul class="nav">
									...
									<li><a href="insertnote.php?code_fil=<?php echo $fil ?>" class="">AJOUTER EXAMEN</a></li>
								</ul>
							</div> 
						</li>
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Supprimer <b>examen :</b></h2>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                		...
                		<tr>
                			<label>Filiere:</label>
            <input type="text" name="code_fil" value="<?php echo $fil ?>" >
                			<label>id_examen:</label>
            <input type="text" name="idEx" >
                		</tr>
                
                        <td><button type="submit" class="btn btn-success" >Supprimer</button></td>
