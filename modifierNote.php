    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Modifier <b>la notes</b></h2>
            ...
            <form method="post" action="updNote.php">
            	
            <table class="table table-striped table-hover table-bordered">
                
                <tbody>
                	<?php 
                	$req="SELECT * from examen join note using(id_exam)JOIN etudiant USING (id_etud) WHERE   id_exam='$id' and id_etud='$id_etud'";
						$rs=$conn ->query($req);
                	while($et=mysqli_fetch_assoc($rs)){  ?>
                		<tr>
                			<label>id_examen:</label>
            <input type="text" name="idEx" value="<?php echo ($et['id_exam']); ?>">
                		</tr>
                	<tr>
                		<td><label>id_etudiant :</label>
                		<input type="text" name="id_etud" value="<?php echo ($et['id_etud']); ?>"></td>
                	</tr>
                    <tr>

                        <td> <label >entrer la note </label><input type="text" name="noteExamen" ></td>
