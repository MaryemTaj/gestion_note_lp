...
$sql="SELECT etudiant.id_etud ,etudiant.cin as cin, etudiant.cne as cne, concat(etudiant.nom_etud ,' ' ,etudiant.prenom_etud) as
Nom_Prenom,module.nom_mod as module ,element.nom_elem as element ,note.note_exam as note ,semestre.id_semestre as semestre ,session.* from note 
...
inner join element on examen.id_elem=element.id_elem
INNER join module on element.id_mod=module.id_mod
INNER join semestre on module.id_semestre=semestre.id_semestre where 
etudiant.id_etud ='$id_etud' and element.nom_elem like   '%$cher%' or
etudiant.id_etud ='$id_etud' and element.id_elem like   '%$cher%' or
 etudiant.id_etud ='$id_etud' and etudiant.cne like '%$cher%'or
 etudiant.id_etud ='$id_etud'and etudiant.nom_etud like'%$cher%'or
 etudiant.id_etud ='$id_etud' and etudiant.prenom_etud like '%$cher%'or
 etudiant.id_etud ='$id_etud' and semestre.id_semestre like '%$cher%'or
 etudiant.id_etud ='$id_etud' and module.nom_mod like '%$cher%' or 
 etudiant.id_etud ='$id_etud' and etudiant.cin like '%$cher%' ";
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user-circle" aria-hidden="true"></i> <span>
                                <?php echo '<strong>'.$_SESSION['prenom_etud'].' '.$_SESSION['nom_etud'].'</strong>';?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
